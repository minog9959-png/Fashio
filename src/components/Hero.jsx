              ...
              <div className="relative z-10 flex h-full items-center"> 
                <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-8 lg:px-4"> 
                  <div className="w-full max-w-[210px] sm:max-w-[390px] lg:max-w-[520px]"> 
                    ...
                    <p className="mt-4 max-w-[200px] text-xs leading-5 text-gray-600 sm:mt-7 sm:max-w-[390px] sm:text-sm sm:leading-7"> 
                      {item.description} 
                    </p> 
 
                    <Link 
                      to="/shop" 
                      className="mt-8 sm:mt-9 inline-block bg-[#B77900] px-6 py-3 text-xs font-semibold uppercase text-white duration-300 hover:bg-[#704900] sm:px-8 sm:py-4 sm:text-sm" 
                    > 
                      SHOP NOW 
                    </Link> 
